...
function getMenu() {
    ...
    const botName = global.BOT_NAME || 'ARSLAN MD';
...
║  ──────────────────────────────────────────────────────────   ║
║  ${p}autoreply (status)                                      ║
║  ${p}autoreply on/off (enable/disable)                       ║
║  ${p}setreply <message> (custom reply set)                   ║
║  ${p}resetreply (default restore)                            ║
║                                                              ║
║  🧠 PSYCHIC & BRAIN                                          ║
║  ──────────────────────────────────────────────────────────   ║
║  ${p}brainscan (brain scan)                                  ║
║  ${p}iqtest (IQ test)                                        ║
║  ${p}mindreader (thoughts read)                              ║
║  ${p}soulmate (soulmate find)                                ║
║  ${p}future (future predict)                                 ║
║  ${p}aura (aura color check)                                 ║
║  ${p}destiny (destiny read)                                  ║
║  ${p}psychic (questions answer)                              ║
║  ${p}personality (personality analysis)                      ║
║  ${p}fortuneteller (fortune tell)                            ║
║                                                              ║
║  💻 HACKER VIBE                                              ║
║  ──────────────────────────────────────────────────────────   ║
║  ${p}whois (domain info)                                     ║
║  ${p}dns (DNS lookup)                                        ║
║  ${p}phone (phone tracker)                                   ║
║  ${p}subdomain (subdomain scan)                              ║
║  ${p}hashcrack (hash crack)                                  ║
║  ${p}malware (malware scan)                                  ║
║  ${p}ddos (DDoS simulation)                                  ║
║  ${p}sqlmap (SQL injection)                                  ║
║  ${p}keylogger (keylogger sim)                               ║
║  ${p}ransom (ransomware sim)                                 ║
║  ${p}hack (general hack sim)                                 ║
║                                                              ║
║  🔧 SYSTEM                                                   ║
║  ──────────────────────────────────────────────────────────   ║
║  ${p}vv                                                      ║
